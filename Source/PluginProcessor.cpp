...
//==============================================================================
const juce::String NeopolitanAudioProcessor::getName() const
{
...
double NeopolitanAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
...
const juce::String NeopolitanAudioProcessor::getProgramName (int index)
{
    return {};
}
...
void NeopolitanAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
